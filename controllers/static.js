  ...
  spaMiddleware({
    ...
    getConfig : async (req, res, next) => {
      next({
        ...
        fullDiskSize : config.fullDiskSize,
        imageScaleFactor : config.imageScaleFactor,
        bandCharacteristics : config.bandCharacteristics,
        epoch : config.epoch,
        coverage : config.coverage,
        spatialResolutions : config.spatialResolutions,
